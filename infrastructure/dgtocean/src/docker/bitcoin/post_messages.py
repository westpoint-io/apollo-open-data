...
block_topic = os.getenv('KAFKA_BLOCK_TOPIC', 'raw-bitcoin-blocks')
transaction_topic = os.getenv(
    'KAFKA_TRANSACTION_TOPIC', 'raw-bitcoin-transactions')
        ...
        try:
            ...
            if socket_general in socks and socks[socket_general] == zmq.POLLIN:
                ...
                if topic == b'rawblock':
                    ...
                    if tx_data:
                        send_message(transaction_topic, tx_data)
                        try:
                            send_message(block_topic, tx_testing_data)
